<div class="main-menu menu-fixed menu-light menu-accordion    menu-shadow " data-scroll-to-active="true">
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                <li class="active"><a href="index.php"><i class="la la-home"></i><span class="menu-title" data-i18n="Dashboard Hospital">ကစ္စည်းသဒ္ဒါကြီး</span></a>
                </li>
                ...
                <li class=" nav-item"><a href="#"><i class="la la-edit"></i><span class="menu-title" data-i18n="Appointment">သန္ဓိကဏ္ဍ</span></a>
                    <ul class="menu-content">
                        <li><a class="menu-item" href="sandi_first.php"><i></i><span>သန္ဓိပထမပိုင်း</span></a>
                        </li>
                        <li><a class="menu-item" href="sandi_second.php"><i></i><span>သန္ဓိဒုတိယပိုင်း</span></a>
                        </li>
                        <li><a class="menu-item" href="sandi_third.php"><i></i><span>သန္ဓိတတိယပိုင်း</span></a>
                        </li>
                        <li><a class="menu-item" href="sandi_fourth.php"><i></i><span>သန္ဓိစတုတ္ထပိုင်း</span></a>
                        </li>
