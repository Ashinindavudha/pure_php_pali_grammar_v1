...
<body class="vertical-layout vertical-menu 2-columns   fixed-navbar" data-open="click" data-menu="vertical-menu" data-col="2-columns">
                    ...
                    <div class="col-12 col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title text-primary text-center">သန္ဓိစတုတ္ထပိုင်း</h4><hr>
                            </div>
                            ...
                            <div class="card-content">
                                <div class="table-responsive">
                                    <table id="sandi_second" class="table table-striped table-bordered active" style="width:100%; font-weight: bold; font-size: 120%;">
                                        <thead>
                                            <tr>
    ...
    $('#sandi_second').DataTable( {
        "ajax": 'json/sandi_fourth.json',
        dom: 'Bfrtip',
        buttons: [
